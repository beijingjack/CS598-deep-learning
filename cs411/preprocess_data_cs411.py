...
if(not os.path.isdir('preprocessed_data_cs411')):
    os.mkdir('preprocessed_data_cs411')
...
## save dictionary
np.save('preprocessed_data_cs411/imdb_dictionary.npy',np.asarray(id_to_word))
np.save('preprocessed_data_cs411/imdb_dictionary_w2id.npy',word_to_id)

## save training data to single text file
with io.open('preprocessed_data_cs411/imdb_train.txt','w',encoding='utf-8') as f:
...
with io.open('preprocessed_data_cs411/imdb_test.txt','w',encoding='utf-8') as f:
